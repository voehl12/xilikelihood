...
import empirical_statistics as es  # For exp_norm_mean
...
def setup_likelihood():
    ...
    ang_bin_in_deg = [(2,3)]
    mask = SphereMask(spins=[2], circmaskattr=(10000, 256), 
                     exact_lmax=EXACT_LMAX, l_smooth=30)
    
    redshift_bin = RedshiftBin(5, filepath='redshift_bins/KiDS/...')
...
if __name__ == "__main__":
    jobnumber = int(sys.argv[1]) - 1
    posterior_from_measurement(jobnumber)