...
plot_corner(simspath=filepath, likelihoodpath=cache_dir, lmax=767, njobs=1000,save_path="comparison_to_sims_with_bootstrap_subplot.png",redshift_indices=correlations_to_plot,angular_indices=angular_bins_to_plot,nbins=256)
