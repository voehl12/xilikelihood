...
class LikelihoodConfig:
    ...
    cf_steps: int = 2048
    pdf_steps: int = 2048
    ximax_sigma_factor: float = 500 #for sampling and only angles larger 20arcmin: 310.0 #70-100 good for 1000 sqd mask, 10000sqd tends to need higher values. Should be set on initializing specific likelihood.
    ximin_sigma_factor: float = 500 #small angular bins tend to need lower values because they are narrower. 
